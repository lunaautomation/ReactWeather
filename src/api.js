...
class APIresult extends React.Component {
  ...
  render() {
    ...
    <WeatherCard day={item.dt_txt}image={item.weather[0].description}description={item.weather[0].description}temp={item.main.temp}feelsTemp={item.main.feels_like}windDir={item.wind.deg}windSpd={item.wind.speed}></WeatherCard>           
